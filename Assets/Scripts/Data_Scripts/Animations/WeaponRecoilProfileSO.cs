...
[CreateAssetMenu(fileName = "NewWeaponRecoilProfile", menuName = "State Shift/Animations/Weapon Recoil Profile")]
public class WeaponRecoilProfileSO : ScriptableObject
{
    ...
    [SerializeField] private float _recoilShakeAmount = 2f;

    [Header("Position Recoil")]
    [Tooltip("Z-axis position impulse.")]
    [SerializeField] private float _kickbackAmount = 0.1f;
